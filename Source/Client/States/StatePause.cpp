	...
	, pause_image(game_data->getRenderer()->createRawSprite())
{
	...
	menu.addButton(game_data->getWindowWidth() / 2.0f - 40.0f, game_data->getWindowHeight() / 2.0f - 60.0f, "CONTINUE", c, ASGE::COLOURS::ANTIQUEWHITE, 80, 20);
	menu.addButton(game_data->getWindowWidth() / 2 - 60, game_data->getWindowHeight() / 2 + 20, "TOGGLE AUDIO", c, ASGE::COLOURS::ANTIQUEWHITE, 80, 20);
	menu.addButton(game_data->getWindowWidth() / 2.0f - 90.0f, game_data->getWindowHeight() / 2.0f + 60.0f, "TOGGLE FULLSCREEN", c, ASGE::COLOURS::ANTIQUEWHITE, 80, 20);
	menu.addButton(game_data->getWindowWidth() / 2.0f - 20.0f, game_data->getWindowHeight() / 2.0f + 100.0f, "EXIT", c, ASGE::COLOURS::ANTIQUEWHITE, 80, 20);
