	...
	, pause_image(game_data->getRenderer()->createRawSprite())
{
	...
	menu.addButton(game_data->getWindowWidth() / 2.0f - 40.0f, game_data->getWindowHeight() / 2.0f - 20.0f, "CONTINUE", c, ASGE::COLOURS::ORANGE, 100.0f, 20.0f, "transparent pixel");
	menu.addButton(game_data->getWindowWidth() / 2.0f - 60.0f, game_data->getWindowHeight() / 2.0f + 20.0f, "TOGGLE AUDIO", c, ASGE::COLOURS::ORANGE, 140.0f, 20.0f, "transparent pixel");
	menu.addButton(game_data->getWindowWidth() / 2.0f - 90.0f, game_data->getWindowHeight() / 2.0f + 60.0f, "TOGGLE FULLSCREEN", c, ASGE::COLOURS::ORANGE, 200.0f, 20.0f, "transparent pixel");
	menu.addButton(game_data->getWindowWidth() / 2.0f - 20.0f, game_data->getWindowHeight() / 2.0f + 100.0f, "EXIT", c, ASGE::COLOURS::ORANGE, 60.0f, 20.0f, "transparent pixel");
